...
import br.com.dazen.core.InvoiceReader;
...
public class App {
	...
	public static void main(String[] args) {
		...
		try {
			...
			InvoiceReader invoiceReader = new InvoiceReader(FILE_INVOICES, roles);
			InvoiceReportGenerator generator = new InvoiceReportGenerator(invoiceReader.getReports(), FILE_REPORT);
